...
#============================================================
#add packages
git clone https://github.com/shmily103/openwrt-7981r128.git
...
#ADD target
\cp -rf openwrt-7981r128/diy/mt7981-spim-nand-7981r128.dts /target/linux/mediatek/files-5.4/arch/arm64/boot/dts/mediatek
\cp -rf openwrt-7981r128/diy/mt7981.mk /target/linux/mediatek/image
